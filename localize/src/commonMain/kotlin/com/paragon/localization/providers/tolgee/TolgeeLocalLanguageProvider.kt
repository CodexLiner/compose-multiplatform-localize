package com.paragon.localization.providers.tolgee
...
import com.paragon.localization.utils.parseXmlString
...
class TolgeeLocalLanguageProvider(providerConfig: ProviderConfig) :
    ...
    private suspend fun downloadLanguage(code: String): Map<String, String> {
        ...
        return if (result.status.isSuccess()) parseXmlString(result.body<String>()) else mapOf()
    }
}